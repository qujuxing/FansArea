...
class AboutTableViewController: UITableViewController {
    ...
    var sectionTitle = ["反馈","关注晓波说雨燕"]
    var sectionContent = [["在App Store上给我们评分","反馈意见"],["网站","博客","学习路线图"]]
    var links = ["https://github.com/","http://www.baidu.com/","http://xiaoboswift.com/roadmap"]
